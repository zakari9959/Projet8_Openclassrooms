...
You can configure a custom domain with GitHub Pages by adding a `CNAME` file to the `` folder.
...
To support `pushState`, make sure to create a `_redirects` file with the following rewrite rules:
